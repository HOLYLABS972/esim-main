...
import Link from 'next/link';
  ...
  const jobPositions = [
    {
      id: 1,
      title: 'נציג פיתוח מכירות',
      location: 'עבודה מרחוק',
      type: 'משרה חלקית',
      description: 'אנחנו מחפשים נציג פיתוח מכירות מוטיבציוני שיצטרף לצוות שלנו ויעזור לנו להרחיב את ההגעה הגלובלית שלנו. הרוויחו 17% עמלה על כל עסקה בהתבסס על הכישורים שלכם. היו הבוס של עצמכם עם חוזה לשנה.',
      requirements: [
        'שנת ניסיון במכירות',
        'מבנה עמלה של 17% מההכנסות',
        'מחויבות לחוזה לשנה',
        'כישורי תקשורת מעולים',
        'מוטיבציה עצמית וממוקדת תוצאות'
      ],
    }
  ];
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            אנחנו מחפשים אנשים מוכשרים שיצטרפו לצוות הגדל שלנו. 
            חקרו את המשרות הפתוחות שלנו ומצאו את התפקיד המושלם עבורכם.
          </p>
        </motion.div>
          ...
          {jobPositions.map((position) => (
            ...
            >
              ...
              <div className="flex space-x-3">
                ...
                <Link
                  href={`/hebrew/jobs/${position.id}/apply`}
        ...
        >
          ...
          <div className="space-y-3 text-gray-600">
            <p>• נבדוק את המועמדות שלכם תוך 2-3 ימי עסקים</p>
            <p>• אם תיבחרו, נצור איתכם קשר לקביעת ראיון</p>
            <p>• תהליך הראיון בדרך כלל לוקח שבוע-שבועיים</p>
            <p>• נודיע לכם על ההחלטה שלנו בדוא"ל</p>
          </div>
        </motion.div>
      </div>
    </div>

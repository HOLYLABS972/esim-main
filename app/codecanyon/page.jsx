...
export default function CodeCanyonPage() {
  ...
  const handleIframeLoad = () => {
    console.log('✅ CodeCanyon iframe loaded successfully');
    setIsLoading(false);
  };

  const handleIframeError = () => {
    console.error('❌ CodeCanyon iframe failed to load');
    setIsLoading(false);
    setError(true);
  };

  useEffect(() => {
    console.log('🔍 CodeCanyon page mounted, attempting to load iframe...');
    ...
    <div className="min-h-screen bg-white">
      ...
      {isLoading && (
        <div className="flex items-center justify-center py-20">
          ...
          <span className="ml-3 text-gray-600">Loading CodeCanyon...</span>
        </div>
      )}

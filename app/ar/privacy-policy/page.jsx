        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                إذا كان لديك أي سؤال بخصوص المعلومات التي قمنا بتخزينها أو بخصوص أي مسألة تتعلق بالخصوصية، لا تتردد في الاتصال بفريقنا عبر البريد الإلكتروني: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                لممارسة أي من هذه الحقوق، يرجى الاتصال بنا على <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>. سنرد على طلبك في غضون 30 يومًا.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                البريد الإلكتروني: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>

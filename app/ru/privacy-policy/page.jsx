        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Если у вас есть какие-либо вопросы относительно хранимой нами информации или по любому вопросу конфиденциальности, не стесняйтесь обращаться к нашей команде по электронной почте: <a href="mailto:info@roamjet.net" className="text-blue-600 hover:underline">info@roamjet.net</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Чтобы воспользоваться любым из этих прав, свяжитесь с нами по адресу <a href="mailto:info@roamjet.net" className="text-blue-600 hover:underline">info@roamjet.net</a>. Мы ответим на ваш запрос в течение 30 дней.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Электронная почта: <a href="mailto:info@roamjet.net" className="text-blue-600 hover:underline">info@roamjet.net</a>
              </p>
            </div>
          </section>

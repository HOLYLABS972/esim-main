        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Should you have any question regarding the information we stored or regarding any privacy issue, do not hesitate to contact our team by email: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                If you would like to delete your Personal Information or permanently delete your account, you can do so on the settings page of your account in the Mobile Application or Website, or simply by contacting us at <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                To exercise any of these rights, please contact us at <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>. We will respond to your request within 30 days.
              </p>
            </div>
          </section>

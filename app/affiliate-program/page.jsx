        ...
        <section className="bg-white py-16">
          <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
            <div className="text-center">
              <h3 className="text-2xl font-bold text-eerie-black mb-4">Ready to Start Earning?</h3>
              <p className="text-cool-black mb-8">Create an account or log in to get your referral code</p>

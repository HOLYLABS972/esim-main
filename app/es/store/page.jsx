  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center mt-2 text-blue-100">
            Descubre nuestra gama completa de productos y servicios de viaje
          </p>
        </div>
      </div>
      ...
      <div className="bg-gray-50 py-8 text-center">
        <p className="text-gray-600 mb-4">
          ¿Tienes problemas para ver la tienda?
        </p>
        <a
          href="https://store.roamjet.net/es"
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition-colors"
        >
          <span>Abrir tienda en nueva pestaña</span>
          <svg 

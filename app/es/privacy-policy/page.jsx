        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Si tiene alguna pregunta sobre la información que almacenamos o sobre cualquier problema de privacidad, no dude en contactar a nuestro equipo por correo electrónico: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Para ejercer cualquiera de estos derechos, contáctenos en <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>. Responderemos a su solicitud dentro de 30 días.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Correo electrónico: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>

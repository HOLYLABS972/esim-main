        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-8">
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Sollten Sie Fragen zu den von uns gespeicherten Informationen oder zu Datenschutzfragen haben, zögern Sie nicht, unser Team per E-Mail zu kontaktieren: <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <div className="space-y-4 text-gray-700 leading-relaxed">
              ...
              <p>
                Um eines dieser Rechte auszuüben, kontaktieren Sie uns bitte unter <a href="mailto:dima@holylabs.net" className="text-blue-600 hover:underline">dima@holylabs.net</a>. Wir werden innerhalb von 30 Tagen auf Ihre Anfrage antworten.
              </p>
            </div>
          </section>

...
const AffiliateProgramPage = () => {
  ...
  const copyReferralCode = async () => {
    if (referralStats.referralCode) {
      try {
        ...
        toast.success('تم نسخ رمز الإحالة إلى الحافظة!');
      } catch (error) {
        console.error('Failed to copy referral code:', error);
        toast.error('فشل في نسخ رمز الإحالة');
      }
    }
  };
  ...
  const shareReferralCode = async () => {
    if (referralStats.referralCode) {
      const shareText = `انضم إلي في RoamJet! استخدم رمز الإحالة الخاص بي: ${referralStats.referralCode}`;
      ...
      if (navigator.share) {
        ...
        try {
          ...
          toast.success('تم نسخ رسالة الإحالة إلى الحافظة!');
        } catch (error) {
    ...
    if (hasBankAccount) {
      ...
      try {
        ...
        if (transactionsSnapshot.empty) {
          toast('لا توجد أرباح إحالة معلقة للسحب', {
            icon: 'ℹ️',
            duration: 3000,
          });
          return;
        ...
        if (totalAmount < minimumWithdrawal) {
          toast.error(`الحد الأدنى للسحب هو $${minimumWithdrawal}. لديك $${totalAmount.toFixed(2)} متاح.`, {
            duration: 5000,
          });
          return;
        }
        ...
        await setDoc(withdrawalRef, {
          ...
          amount: totalAmount,
          description: `سحب ${updatedCount} أرباح إحالة`,
          status: 'completed',
          method: 'withdrawal',
        ...
        toast.success(`تم سحب $${totalAmount.toFixed(2)} بنجاح من ${updatedCount} أرباح إحالة!`);
        ...
        toast.error('فشل في معالجة السحب');
      }
    } else {
  ...
  const structuredData = {
    ...
    "@type": "WebPage",
    "name": "برنامج الشراكة - Roam Jet Plans",
    "description": "انضم إلى برنامج الشراكة الخاص بنا واربح $1 لكل صديق تحيله إلى Roam Jet Plans",
    "url": `${process.env.NEXT_PUBLIC_BASE_URL || "https://esimplans.com"}/arabic/affiliate-program`,
    "mainEntity": {
      "@type": "ProgramMembership",
      "name": "برنامج الشراكة Roam Jet Plans",
      "description": "اربح $1 عمولة لكل إحالة ناجحة",
      "programName": "برنامج الشراكة Roam Jet Plans",
      "member": {
        "@type": "Person",
        "name": "عضو شريك"
      },
      "offers": {
        "@type": "Offer",
        "name": "عمولة الإحالة",
        "description": "$1 عمولة لكل إحالة ناجحة",
        "price": "1.00",
        "priceCurrency": "USD"
      }
    },
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "برنامج الشراكة",
          "item": `${process.env.NEXT_PUBLIC_BASE_URL || "https://esimplans.com"}/arabic/affiliate-program`
        }
      ]
    }
  };
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          <div className="text-center mb-6">
            <h3 className="text-xl font-bold text-gray-900 mb-2">أداؤك</h3>
            <p className="text-gray-600">تتبع نجاح إحالاتك</p>
          </div>
              ...
              <div className="text-center">
                <div className="bg-gray-50 rounded-lg p-6 mb-4">
                  <p className="text-3xl font-bold font-mono text-gray-900">
                    {referralStats.referralCode || 'جاري التحميل...'}
                  </p>
                  <p className="text-sm text-gray-600">رمز الإحالة الخاص بك</p>
                </div>
        ...
        {hasBankAccount && (
          ...
          >
            <div className="text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-4">اسحب أرباحك</h3>
              <p className="text-gray-600 mb-2">
                انقل أرباح إحالاتك إلى حسابك المصرفي
              </p>
              <p className="text-sm text-gray-500 mb-6">
                الحد الأدنى للسحب: $50.00
              </p>
              <button
              ...
              >
                ...
                <span>
                  {checkingBankAccount 
                    ? 'جاري التحقق...' 
                    : referralStats.totalEarnings < 50 
                      ? `تحتاج $${(50 - referralStats.totalEarnings).toFixed(2)} إضافية` 
                      : 'اسحب الأموال'
                  }
                </span>
              </button>
        ...
        {!hasBankAccount && !checkingBankAccount && (
          ...
          >
            <div className="text-center">
              <h3 className="text-lg font-bold text-gray-900 mb-4">أضف حساب مصرفي</h3>
              <p className="text-gray-600 mb-6">
                أضف تفاصيل حسابك المصرفي لسحب أرباحك
              </p>
              <button
                onClick={handleWithdrawClick}
        ...
        <motion.div
          ...
          className="bg-white rounded-xl shadow-lg p-6 mb-8"
        >
          <h3 className="text-xl font-bold text-gray-900 mb-6 text-center">كيف يعمل</h3>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="bg-blue-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <span className="text-2xl font-bold text-blue-600">1</span>
              </div>
              <h4 className="font-semibold text-gray-900 mb-2">شارك رمزك</h4>
              <p className="text-sm text-gray-600">انسخ وشارك رمز الإحالة الفريد الخاص بك مع الأصدقاء</p>
            </div>
            <div className="text-center">
              <div className="bg-green-100 p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
                <span className="text-2xl font-bold text-green-600">2</span>
              </div>
              <h4 className="font-semibold text-gray-900 mb-2">صديقك يسجل</h4>
              <p className="text-sm text-gray-600">صديقك يستخدم رمزك عند إنشاء حسابه</p>
            </div>
            <div className="text-center">

...
def create_payment_order():
    ...
    try:
        ...
        # Generate a proper order ID for tracking
        ...
        session = stripe.checkout.Session.create(
            ...
            mode='payment',
            success_url=f'{domain}/payment-success?order_id={order_id}&plan_id={order}&email={email}&total={total}&name={name}&currency={currency}',

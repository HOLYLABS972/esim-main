...
const Login = () => {
  ...
  const handleEmailSubmit = async (e) => {
    ...
    if (!email) {
      toast.error(t('auth.login.fillEmail', 'Please enter your email address'));
      return;
    }
    ...
    if (!emailRegex.test(email)) {
      toast.error(t('auth.login.invalidEmail', 'Please enter a valid email address'));
      return;
    }
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    if (!password) {
      toast.error(t('auth.login.fillPassword', 'Please enter your password'));
      return;
    }
                  ...
                  <div className="mb-4">
                    <div className="flex items-center mb-2">
                      <button
                        ...
                        aria-label="Back"
                      >
                        <ArrowLeft className="h-5 w-5 text-cool-black" />
                      </button>
                      <div>
                        <p className="text-sm text-cool-black font-medium">{email}</p>
                        <p className="text-xs text-cool-black opacity-60">
                          {t('auth.login.step2Subtitle', 'Enter your password to continue')}
                        </p>
                      </div>
                    </div>
                  </div>

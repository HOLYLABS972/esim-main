              ...
              {loadingReferralStats ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  {/* Referral Code Card */}
                    ...
                    <div className="bg-tufts-blue/5 rounded-xl p-6 mb-4 border border-tufts-blue/10">
                      <div className="flex items-left justify-left mb-3">
                        <Gift className="w-8 h-8 text-tufts-blue" />
                      </div>
                      <p className="text-2xl font-bold font-mono text-eerie-black mb-2">
                        {referralStats.referralCode || t('affiliate.loading', 'Loading...')}
                      </p>
                      <p className="text-lg text-cool-black font-medium">{t('affiliate.yourReferralCode', 'Your Referral Code')}</p>
                    </div>
                  ...
                  <div className="text-left">
                        <div className="bg-tufts-blue/5 rounded-xl p-6 border border-tufts-blue/10">
                      <div className="flex items-left justify-left mb-4">
                        <Users className="w-8 h-8 text-tufts-blue" />
                      </div>
                      <p className="text-2xl font-bold text-eerie-black mb-2">{referralStats.usageCount}</p>
                      <p className="text-lg text-cool-black font-medium">{t('affiliate.totalReferrals', 'Total Referrals')}</p>
                    </div>
                  </div>
                  ...
                  <div className="text-left">
                    <div className="bg-tufts-blue/5 rounded-xl p-6 border border-tufts-blue/10">
                        <div className="flex items-left justify-left mb-4">
                        <Wallet className="w-8 h-8 text-tufts-blue" />
                      </div>
                      <button
                        onClick={onEarningsClick}
                        className="text-2xl font-medium text-left text-eerie-black hover:text-cobalt-blue transition-colors cursor-pointer mb-2 block w-full"
                      >
                        ${referralStats.totalEarnings.toFixed(2)}
                      </button>
                      <p className="text-lg text-cool-black font-medium">{t('affiliate.totalEarnings', 'Total Earnings')}</p>
                    </div>
                  </div>
                </div>
              )}

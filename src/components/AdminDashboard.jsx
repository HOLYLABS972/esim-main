...
const AdminDashboard = ({ initialTab = 'esim' }) => {
        ...
        plans.forEach(plan => {
          if (plan.slug && plan.name) {
            ...
            batch.set(planRef, {
              ...
              operator: typeof plan.operator === 'string' ? plan.operator : (plan.operator?.title || plan.operator?.name || ''),
              status: 'active',
              updated_at: new Date(),
              synced_at: new Date().toISOString()
            }, { merge: true });
                      ...
                      <div className="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          ...
                          >
                            ...
                            <p className="font-medium">Affiliate</p>
                            <p className="text-sm text-gray-600">Review and manage applications</p>
                          </button>
                          <button
                            onClick={() => setActiveTab('notifications')}
                            className="p-4 border border-gray-200 rounded-lg hover:border-orange-300 hover:bg-orange-50 transition-all duration-200"
                          >

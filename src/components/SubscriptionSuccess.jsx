  ...
  useEffect(() => {
    const handlePaymentSuccess = async () => {
      try {
        ...
        console.log('📞 Calling Firebase create_order function with:', { planId, sessionId });
        ...
        console.log('📞 Calling Firebase get_esim_qr_code function with orderId:', orderResult.data.orderId);
